      ...
      <section className="w-full max-w-md">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-xs sm:text-sm text-slate-500">
            Sign in to access your image workspace and download history.
          </p>
        </div>
        ...
        {registered && (
          <div
            role="status"
            className="mb-4 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-xs sm:text-sm font-medium text-emerald-800"
          >
